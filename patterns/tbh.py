...
class TBH(Base):
    ...
    def call(self):
        ...
        if hasattr(candles, 'first_candle'):
            ...
            predicted_price = loaded_model.predict([[up[26] - candles.first_candle.candle_close, lw[26] - candles.first_candle.candle_close, candles.first_candle.candle_height - candles.second_candle.candle_height, K[28], rsi14[28], D[28]]])
